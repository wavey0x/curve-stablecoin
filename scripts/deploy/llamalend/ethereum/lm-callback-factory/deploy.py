...
Run:
    ...
    MAINNET_RPC_URL=... python scripts/deploy/llamalend/ethereum/lm-callback-factory/\
deploy.py --dry-run --account-name <name>

    # broadcast
    MAINNET_RPC_URL=... python scripts/deploy/llamalend/ethereum/lm-callback-factory/\
deploy.py --account-name <name>
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--report-path",
        default="deployments/llamalend/ethereum/lm-callback-factory.jsonc",
